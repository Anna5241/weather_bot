...
class SubscribeForWeaherInCity extends Command implements CommandInterface
{
    protected string $name = 'subscribe_for_weather_in_city';
    ...
    public function handle()
    {
        ...
        $city = trim(str_replace('/subscribe_for_weather_in_city', '', $text));

        if (empty($city)) {
            $this->replyWithMessage([
                'text' => 'ℹ️ Пожалуйста, укажите город. Например: /subscribe_for_weather_in_city Москва',
            ]);
            return;
        }
